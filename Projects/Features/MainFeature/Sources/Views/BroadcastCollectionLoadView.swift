...
// MARK: - BroadcastCollectionLoadView
...
final class BroadcastCollectionLoadView: BaseView {
    ...
    struct BroadcastCollectionLoadViewPreview: UIViewRepresentable {
        func makeUIView(context _: Context) -> BroadcastCollectionLoadView {
            BroadcastCollectionLoadView()
        }

        func updateUIView(_: BroadcastCollectionLoadView, context _: Context) {}
    }
