...
// MARK: - BroadcastCollectionViewController
...
public class BroadcastCollectionViewController: BaseViewController<BroadcastCollectionViewModel> {
    ...
    private let rightBarButton: UIBarButtonItem = .init()
...
extension BroadcastCollectionViewController {
    ...
    private func showBroadcastUIView() {
        ...
        addChild(broadcastViewController)
        view.addSubview(broadcastViewController.view)
        broadcastViewController.view.frame = view.bounds
    ...
    private func dismissBroadcastView() {
        DispatchQueue.main.async { [weak self] in
            ...
            UIView.animate(withDuration: 0.3, delay: 0, options: [.curveEaseInOut], animations: {
                broadcastViewController.view.alpha = 0
            }, completion: { _ in
